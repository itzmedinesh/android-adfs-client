 ...
 * authentication, parse the successful response to provide BST, JWT tokens.
 * 
 * @author itzmeds
 *
 */
public interface SignOnService {
	...
	enum TokenTypes {
		BST_TOKEN_TYPE("urn:ietf:params:oauth:token-type:jwt"), JWT_TOKEN_TYPE("urn:ietf:params:oauth:token-type:jwt");
